...
export const SYSTEM = {
    ...
    // 글꼴 설정
    FONTS: {
        PRIMARY: "'Paperlogy', 'Noto Sans KR', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
...
export const ROUTE_CONFIG = {
    ...
    SALES: {
        ...
        DATA_MANAGEMENT: '/03.sales_mode/06_data_management/01_data_management.html',
    ...
    ADMIN: {
        ...
        DATA_MANAGEMENT: '/04.admin_mode/07_data_management/01_data_management.html',
        EMPLOYEE_MANAGEMENT: '/04.admin_mode/08_employee_management/01_employees.html',
